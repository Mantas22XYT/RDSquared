...
public class ZombieModel {
	...
	public void render(float var1) {
		this.head.yRot = (float)Math.sin((double)var1 * 0.83D) * 1.0F;
		this.head.xRot = (float)Math.sin((double)var1) * 0.8F;
		this.arm0.xRot = (float)Math.sin((double)var1 * 0.6662D + Math.PI) * 2.0F;
		this.arm0.zRot = (float)(Math.sin((double)var1 * 0.2312D) + 1.0D) * 1.0F;
		this.arm1.xRot = (float)Math.sin((double)var1 * 0.6662D) * 2.0F;
		this.arm1.zRot = (float)(Math.sin((double)var1 * 0.2812D) - 1.0D) * 1.0F;
